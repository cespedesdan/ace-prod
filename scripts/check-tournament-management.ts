...
assert.equal(tournamentPrizeLabel('ace-clutch-3', 20000), '5 mousepads Logitech + R$ 200,00')
assert.equal(tournamentPrizeBreakdown('ace-clutch-3'), '1º lugar: R$ 125,00 · 2º lugar: R$ 75,00')
