...
Google Fonts repository. It retains the angular esports character of the prior
Nippo face while allowing modification and redistribution under the OFL stored
in `OFL-Chakra-Petch.txt`. Its data URL is inlined so heading text never waits
for a font request or swaps after first paint.
