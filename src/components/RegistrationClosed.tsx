    ...
    <main className="tournament-page clutch-page registration-page min-h-screen text-white">
      <section className="tournament-hero copa10-hero registration-hero flex min-h-[calc(100vh-5rem)] items-center">
        ...
        <div className="tournament-container relative grid gap-8 py-10 lg:grid-cols-[1fr_380px] lg:py-14">
          <div>
            <div className="registration-open-badge mt-7 inline-flex items-center gap-2 border bg-[#bd1159]/10 px-3 py-1.5 text-xs font-black uppercase tracking-[0.14em] text-[#ff9ac5]">
              <span className="h-2 w-2 bg-[#ff9ac5]" /> Inscrições encerradas
            </div>
            ...
            <div className="mt-7 flex flex-wrap gap-3 text-xs font-bold text-slate-300">
              <span className="inline-flex items-center gap-2 bg-white/5 px-3 py-2"><LockKeyhole size={15} className="text-[#ff9ac5]" /> Inscrições encerradas</span>
            </div>
          </div>
          <aside className="registration-aside self-end border border-[#bd1159]/30 bg-black/45 p-5">
            <h2 className="font-black text-white">Acompanhe os próximos campeonatos</h2>
            <ul className="mt-4 space-y-3 text-sm text-slate-300">
              <li className="flex gap-2.5"><CalendarDays size={17} className="mt-0.5 shrink-0 text-[#ff9ac5]" /> Consulte datas e horários na agenda.</li>
            </ul>
          </aside>
        </div>
      </section>
